    ...
    <div>
        ...
        <nav class="menu" :class="{ 'menu-aberto': menuAberto }">
            <ul>
                ...
                <router-link to="/calculadora-Acustico" tag="li" active-class="active" @click.native="menuAberto = false">
                    <a>Calculatora do fenomeno acustico</a>
                </router-link>
                <router-link to="/acustica-Educacional-Projeto" tag="li" active-class="active" @click.native="menuAberto = false">
                    <a>Abordagem educacional do projeto</a>
                </router-link>
            </ul>
        </nav>
    </div>
